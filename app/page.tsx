...
function UseCaseThumbnail({ type }: { type: string }) {
  ...
  if (type === 'ai') {
    return <div className="mb-6 flex h-28 items-center justify-center rounded-2xl border border-cyan-400/15 bg-gradient-to-br from-[#0D1725] to-[#111827] p-5"><div className="grid w-full max-w-[240px] grid-cols-[1fr_auto_1fr] items-center gap-3"><div className="rounded-2xl border border-cyan-400/25 bg-cyan-400/10 px-4 py-3 text-center"><div className="font-mono text-[10px] uppercase tracking-[0.22em] text-cyan-200">Data</div><div className="mt-1 text-xs text-zinc-300">knowledge</div></div><div className="h-px w-8 bg-cyan-300/40" /><div className="rounded-2xl border border-blue-400/25 bg-blue-400/10 px-4 py-3 text-center"><div className="font-mono text-[10px] uppercase tracking-[0.22em] text-blue-200">AI</div><div className="mt-1 text-xs text-zinc-300">workflow</div></div><div className="col-span-3 mx-auto mt-2 rounded-full border border-white/10 bg-white/[0.04] px-4 py-1 font-mono text-[10px] uppercase tracking-[0.22em] text-zinc-400">governed integration</div></div></div>
  }
