...
const roles = [
  { title: 'Software Engineers', text: 'Conception et développement de plateformes logicielles modernes, robustes et maintenables.' },
  ...
  { title: 'Tech Leads', text: 'Leadership engineering, qualité delivery, mentoring et accompagnement équipes.' },
]

const values = ['Forte culture engineering', 'Équipes seniors', 'Projets modernes complexes', 'IA, architecture et Web3', 'Autonomie & ownership', 'Partage de connaissance']
  ...
  return (
    <>
      ...
      <main className="mx-auto max-w-7xl px-6 py-24 text-white">
        ...
        <h1 className="mt-4 max-w-5xl font-display text-6xl font-bold tracking-tight">Rejoindre une équipe engineering senior.</h1>
        <p className="mt-8 max-w-3xl text-lg leading-8 text-zinc-400">Nous recherchons des personnes passionnées par les systèmes complexes, l’architecture, les plateformes AI-ready, les systèmes distribués et le software craftsmanship.</p>
