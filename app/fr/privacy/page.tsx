...
export default function PrivacyPageFR() {
  return (
    <LegalPage
      ...
      updated="Mai 2026"
      sections={[
        { title: 'Responsable du traitement', paragraphs: ['Le responsable du traitement est Teragone Factory, éditrice du site et destinataire des demandes transmises via le formulaire de contact.'] },
