...
const expertises = [
  { title: 'Audit & Architecture', href: '/fr/expertises/audit', text: 'Evaluation technique, revue architecture, dette technique, performance, securite, gouvernance, roadmap de modernisation et architecture cible pour plateformes critiques.' },
  { title: 'Delivery & Squads seniors', href: '/fr/expertises/delivery', text: 'Squads seniors et AI-ready pour concevoir, construire, industrialiser et livrer des systemes critiques avec une forte culture craft, IA engineering et production.' },
  { title: 'IA & Systemes agentiques', href: '/fr/expertises/ia-agentique', text: 'Architectures AI-ready, RAG, orchestration LLM, agents autonomes, automatisation et integration enterprise-grade dans les systemes information existants.' },
  { title: 'Web3 & Blockchain', href: '/fr/expertises/web3', text: 'Systemes distribues, infrastructure blockchain, ingenierie protocolaire, validation legere, synchronisation reseau, gaming, agents IA et plateformes Web3.' },
]
