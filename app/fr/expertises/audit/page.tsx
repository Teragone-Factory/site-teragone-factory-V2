  ...
  return (
    <>
      ...
      <main className="mx-auto max-w-7xl px-6 py-24 text-white">
        ...
        <p className="mt-8 max-w-3xl text-lg leading-8 text-zinc-400">Nous aidons les organisations à comprendre l’état réel de leurs plateformes critiques, à identifier les risques et à construire une trajectoire de modernisation claire, priorisée et réaliste.</p>
