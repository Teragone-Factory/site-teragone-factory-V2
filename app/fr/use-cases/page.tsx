...
const cases = [
  { sector: 'Mobilité & Transport', pillar: 'Architecture & Delivery', visual: 'legacy', problem: 'Moderniser une plateforme legacy sans interrompre l’activité.', story: `Un grand acteur de la mobilité avait atteint un point où chaque évolution du système d’information devenait plus lente, plus risquée et plus difficile à opérer.

La plateforme continuait à délivrer de la valeur métier au quotidien, mais l’accumulation progressive de dette technique, le manque d’observabilité et la fragilité des flux de delivery créaient une tension croissante entre les enjeux de transformation, de stabilité et de performance opérationnelle.

À mesure que le SI gagnait en criticité, la capacité des équipes à faire évoluer la plateforme rapidement, de manière fiable et maîtrisée, devenait un enjeu stratégique pour l’entreprise.`, intervention: `Nous avons réalisé un audit d’architecture et de code, cartographié les flux critiques, clarifié les principaux risques et défini une trajectoire de modernisation à fort impact, sans réécriture big-bang. Nous avons ensuite accompagné la mise en place d’une squad senior, l’industrialisation CI/CD, l’amélioration de l’observabilité, les travaux de performance et la consolidation de la production.`, benefits: `La plateforme est devenue plus lisible, plus simple à opérer et plus évolutive. Les équipes ont gagné en visibilité, le risque de delivery a diminué et l’organisation a retrouvé la capacité d’avancer sans fragiliser un système clé.` },
