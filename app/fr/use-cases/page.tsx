...
const cases = [
  { sector: 'Mobilité & Transport', pillar: 'Architecture & Delivery', visual: 'legacy', problem: 'Moderniser une plateforme legacy critique sans interrompre l’activité.', story: 'Une grande plateforme de mobilité avait atteint un point où chaque évolution devenait plus lente, plus risquée et plus difficile à opérer. Le système continuait à produire de la valeur métier, mais la dette technique, le manque d’observabilité et des flux de delivery fragiles créaient une pression croissante sur les équipes IT et métier.', intervention: 'Nous avons démarré par un audit d’architecture et de code, clarifié les principaux risques, cartographié les flux critiques et identifié la trajectoire de modernisation qui créerait le plus d’impact sans déclencher de réécriture big-bang risquée. Nous avons ensuite accompagné la mise en place d’une squad senior, l’industrialisation CI/CD, les améliorations d’observabilité, les travaux de performance et le durcissement progressif de la production.', benefits: 'La plateforme est devenue plus compréhensible, plus sûre à opérer et plus prévisible à faire évoluer. Les équipes ont gagné en visibilité, le risque delivery a diminué, la modernisation est devenue actionnable et l’organisation a retrouvé la capacité d’avancer sans déstabiliser un système critique.' },
