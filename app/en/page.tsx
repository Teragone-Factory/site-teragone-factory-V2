...
const pillars = [
  { title: 'Audit & Expertise', description: 'Technical audits, architecture, software debt and pragmatic modernization to regain control over critical systems.', href: '/en/expertises/audit', visual: '🧭', proof: 'Architecture & governance', accent: 'from-blue-500/30 to-cyan-400/20' },
  { title: 'Delivery & Senior Squads', description: 'AI-ready senior squads able to design, take over and industrialize complex platforms with a strong engineering culture.', href: '/en/expertises/delivery', visual: '⚙️', proof: 'Software craftsmanship', accent: 'from-violet-500/30 to-blue-400/20' },
  { title: 'AI & Agentic Systems', description: 'RAG, LLM orchestration, autonomous agents and AI engineering to build intelligent systems that can be operated in production.', href: '/en/expertises/ia-agentique', visual: '✦', proof: 'AI-ready systems', accent: 'from-cyan-500/30 to-emerald-400/20' },
...
const differentiators = [
  ['01', 'Senior expertise', 'Experienced profiles on critical challenges, able to make fast and sound technical decisions.'],
  ['02', 'AI inside', 'AI engineering is embedded into practices, architectures and delivery workflows.'],
  ['03', 'Long-term thinking', 'Architecture choices designed for maintainability, governance and platform evolution.'],
  ['04', 'Production focus', 'A simple obsession: deliver reliable, observable and operable production systems.'],
  ['05', 'Craft quality', 'High software quality standards across tests, documentation, maintainability and transmission.'],
]
...
function UseCaseThumbnail({ type }: { type: string }) {
  ...
  if (type === 'ai') return <div className="mb-6 flex h-28 items-center justify-center rounded-2xl border border-cyan-400/15 bg-gradient-to-br from-[#0D1725] to-[#111827] p-5"><div className="flex items-center gap-4"><div className="flex h-14 w-14 items-center justify-center rounded-2xl border border-cyan-400/25 bg-cyan-400/10 text-lg text-cyan-200">AI</div><div className="h-px w-10 bg-cyan-300/35" /><div className="flex h-14 w-14 items-center justify-center rounded-2xl border border-blue-400/25 bg-blue-400/10 text-lg text-blue-200">API</div></div></div>
  return <div className="mb-6 flex h-28 items-center justify-center rounded-2xl border border-blue-400/15 bg-gradient-to-br from-[#0E1726] to-[#111827] p-5"><div className="flex items-center gap-3"><div className="h-12 w-12 rounded-2xl border border-white/10 bg-white/[0.04]" /><div className="flex flex-col gap-2"><div className="h-2 w-20 rounded-full bg-blue-300/35" /><div className="h-2 w-14 rounded-full bg-white/20" /></div><div className="h-12 w-12 rounded-2xl border border-blue-400/25 bg-blue-400/10" /></div></div>
}
