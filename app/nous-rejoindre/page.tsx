...
const roles = [
  { title: 'Software Engineers', text: 'Conception et developpement de plateformes logicielles modernes, robustes et maintenables.' },
  { title: 'AI Engineers', text: 'Industrialisation IA, orchestration LLM, agents, RAG et plateformes AI-ready.' },
  { title: 'Solution Architects', text: 'Architecture logicielle, modernisation, systemes distribues et gouvernance technique.' },
  { title: 'Tech Leads', text: 'Leadership engineering, qualite delivery, mentoring et accompagnement equipes.' },
]
