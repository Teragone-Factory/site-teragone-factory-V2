...
const values = ['Strong engineering culture', 'Senior teams', 'Complex modern projects', 'AI, architecture and Web3', 'Autonomy and ownership', 'Knowledge sharing']
  ...
  return (
    <>
      ...
      <main className="mx-auto max-w-7xl px-6 py-24 text-white">
        ...
        <section className="mt-24 rounded-[2rem] border border-white/10 bg-card p-10 md:p-16"><span className="text-sm uppercase tracking-[0.3em] text-primary">Our approach</span><h2 className="mt-4 max-w-4xl font-display text-5xl font-bold tracking-tight">Senior teams building durable systems.</h2><p className="mt-8 max-w-3xl text-lg leading-8 text-zinc-400">We value environments where engineering has real impact: architecture, software quality, delivery, modernization, AI, distributed platforms and ambitious technical challenges.</p></section>
      </main>
      <FinalCTAEn />
      <Footer />
    </>
