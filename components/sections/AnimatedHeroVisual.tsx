const rows = [
  { left: 'AI', leftDetail: 'context', middle: 'Agent layer', middleDetail: 'orchestrate', right: 'Business action', rightDetail: 'apps APIs' },
  { left: 'Web3', leftDetail: 'identity assets', middle: 'Trust layer', middleDetail: 'verify sign', right: 'Decentralized system', rightDetail: 'on chain' },
]
    ...
    <div className="relative h-[400px] overflow-hidden rounded-[2rem] border border-white/10 bg-card p-7 shadow-2xl shadow-primary/10 light-hero-visual">
      ...
      <div className="relative flex h-full flex-col justify-center gap-6">
        ...
        <div className="grid grid-cols-3 gap-3 border-t border-white/10 pt-4 text-center">
          <div><p className="font-mono text-[10px] uppercase tracking-[0.18em] text-white">Understand</p><p className="mt-1 text-[11px] text-zinc-500">AI</p></div>
          <div><p className="font-mono text-[10px] uppercase tracking-[0.18em] text-white">Orchestrate</p><p className="mt-1 text-[11px] text-zinc-500">Agents</p></div>
          <div><p className="font-mono text-[10px] uppercase tracking-[0.18em] text-white">Verify</p><p className="mt-1 text-[11px] text-zinc-500">Web3</p></div>
        </div>
      </div>
    </div>
  )
