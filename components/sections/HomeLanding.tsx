...
const data = {
  en: {
    ...
    differentiators: [
      { number: '01', title: 'Senior expertise', text: 'Experienced engineers and architects for critical technical challenges and fast, sound decision-making.', icon: '♟' },
      { number: '02', title: 'AI inside', text: 'AI engineering is embedded into development practices, architecture work and delivery workflows.', icon: '✦' },
      { number: '03', title: 'Long-term thinking', text: 'Architecture choices designed for maintainability, governance, operability and platform evolution.', icon: '∞' },
      { number: '04', title: 'Production focus', text: 'A simple obsession: deliver reliable, observable and production-ready systems.', icon: '◉' },
      { number: '05', title: 'Craft quality', text: 'High software quality standards across tests, documentation, maintainability and knowledge transfer.', icon: '◆' },
    ],
    useCases: [
