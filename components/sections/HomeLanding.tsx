...
const data = {
  en: {
    ...
    expertiseTitle: 'Engineering expertise designed for critical systems.',
    expertiseDescription: 'We help organizations modernize, industrialize and evolve complex platforms with a pragmatic, senior and production-first approach.',
    whyEyebrow: 'Why Teragone Factory',
    whyTitle: 'Senior engineering. Long-term vision.',
    whyText: 'We combine craft excellence, AI engineering and production culture to help teams build better, faster and more sustainably.',
    cta: 'en',
    tags: ['Architecture & modernization', 'AI engineering & agents', 'Production-grade delivery', 'Distributed systems & Web3'],
    pillars: [
      { title: 'Audit & Architecture', description: 'Technical audits, architecture reviews, software debt analysis and pragmatic modernization roadmaps for critical systems.', href: '/expertises/audit', visual: '🧭', proof: 'Architecture & governance', accent: 'from-blue-500/30 to-cyan-400/20' },
      { title: 'Delivery & Senior Squads', description: 'AI-enabled senior squads able to design, take over and industrialize complex platforms with a strong engineering culture.', href: '/expertises/delivery', visual: '⚙️', proof: 'Software craftsmanship', accent: 'from-violet-500/30 to-blue-400/20' },
      { title: 'AI & Agentic Systems', description: 'RAG, LLM orchestration, autonomous agents and AI engineering practices to build intelligent systems that can run in production.', href: '/expertises/ia-agentique', visual: '✦', proof: 'AI-ready systems', accent: 'from-cyan-500/30 to-emerald-400/20' },
      { title: 'Web3 & Blockchain', description: 'Protocol engineering, distributed infrastructure, Web3 platforms and the convergence of AI, agents and decentralized systems.', href: '/expertises/web3', visual: '◈', proof: 'Distributed systems', accent: 'from-fuchsia-500/30 to-violet-400/20' },
    ],
    differentiators: [
  ...
  fr: {
    ...
    expertiseTitle: 'Une expertise engineering pensée pour les systèmes critiques.',
    expertiseDescription: 'Nous accompagnons les organisations qui doivent moderniser, industrialiser et faire évoluer des plateformes complexes avec une approche pragmatique, senior et orientée production réelle.',
    whyEyebrow: 'Pourquoi Teragone Factory',
    whyTitle: 'Engineering senior. Vision long terme.',
    whyText: 'Nous combinons exigence craft, AI engineering et culture production pour aider les équipes à construire mieux, plus vite et plus durablement.',
    cta: 'fr',
    tags: ['Architecture & modernisation', 'AI engineering & agents', 'Delivery production-grade', 'Distributed systems & Web3'],
    pillars: [
      { title: 'Audit & Expertise', description: 'Audits techniques, architecture, dette logicielle et modernisation pragmatique pour reprendre le contrôle sur des systèmes critiques.', href: '/fr/expertises/audit', visual: '🧭', proof: 'Architecture & gouvernance', accent: 'from-blue-500/30 to-cyan-400/20' },
      { title: 'Delivery & Squads Seniors', description: 'Des squads seniors AI-ready capables de concevoir, reprendre et industrialiser des plateformes complexes avec une forte culture engineering.', href: '/fr/expertises/delivery', visual: '⚙️', proof: 'Software craftsmanship', accent: 'from-violet-500/30 to-blue-400/20' },
      { title: 'IA & Systèmes Agentiques', description: 'RAG, orchestration LLM, agents autonomes et AI engineering pour construire des systèmes intelligents réellement exploitables.', href: '/fr/expertises/ia-agentique', visual: '✦', proof: 'AI-ready systems', accent: 'from-cyan-500/30 to-emerald-400/20' },
      { title: 'Web3 & Blockchain', description: 'Protocol engineering, infrastructures distribuées, plateformes Web3 et convergence IA + agents + systèmes décentralisés.', href: '/fr/expertises/web3', visual: '◈', proof: 'Distributed systems', accent: 'from-fuchsia-500/30 to-violet-400/20' },
    ],
    differentiators: [
...
export function HomeLanding() {
  ...
  const content = isFrench ? data.fr : data.en
  ...
  return (
    <>
      ...
      <main className="overflow-hidden bg-background text-white">
        ...
        <DeliveryMethod />
        <section className="relative border-y border-white/5 bg-surface"><div className="absolute inset-0 bg-[radial-gradient(circle_at_15%_20%,rgba(59,130,246,0.12),transparent_35%),radial-gradient(circle_at_85%_70%,rgba(139,92,246,0.10),transparent_35%)]" /><div className="relative mx-auto max-w-7xl px-6 py-28"><div className="grid gap-12 lg:grid-cols-[0.8fr_1.2fr] lg:items-center"><div><span className="text-sm uppercase tracking-[0.3em] text-primary">{content.whyEyebrow}</span><h2 className="mt-4 font-display text-5xl font-bold tracking-tight md:text-6xl">{content.whyTitle}</h2><p className="mt-6 text-lg leading-8 text-zinc-400">{content.whyText}</p></div><div className="grid gap-4 md:grid-cols-2">{content.differentiators.map(([number, title, text]) => <div key={title} className="group rounded-[1.7rem] border border-white/10 bg-card p-6 transition hover:-translate-y-1 hover:border-primary/40 hover:bg-white/[0.04]"><div className="mb-6 flex items-center justify-between"><span className="font-mono text-xs uppercase tracking-[0.24em] text-primary">{number}</span><div className="h-10 w-10 rounded-2xl bg-primary/15" /></div><h3 className="font-display text-2xl font-semibold text-white">{title}</h3><p className="mt-3 leading-7 text-zinc-400">{text}</p></div>)}</div></div></div></section>
        <ProofBar />
        <RecruitmentTeaser />
        {content.cta === 'en' ? <FinalCTAEn /> : <FinalCTA />}
      </main>
      <Footer />
    </>
  )
